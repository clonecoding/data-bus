    ...
    public CanalRocketMsg buildMsg(Message message) {
        ...
        for (CanalEntry.Entry entry : entrys) {
            ...
            if (entry.getEntryType() == CanalEntry.EntryType.ROWDATA) {
                ...
                org.apache.rocketmq.common.message.Message value = new org.apache.rocketmq.common.message.Message(canalRocketMsg.getTopic(), (String) canalRocketMsg.getArg(), "POS" + binlogPosition, msgBtyes);
